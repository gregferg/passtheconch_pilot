    ...
    if (this.state.searching) {
      ...
      return (
        <div className="how-to-play-story-container">
          ...
          <HowToPlayTextBox finshedRenderingText={this.nextStep} textToRender={howToPlayText[textToDisplay]}/>
          ...
          {this.state.idx > 7 ? <BeginNewStory buttonTitle="Make a story!" className="story animate-fade-and-slide1"/> : <p></p>}
        </div>
      );
    }
  },
